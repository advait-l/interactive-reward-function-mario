...
set shortmess=aoO
badd +0 js/marioAgent/model.js
badd +0 js/marioAgent/CoinPlot.js
badd +0 js/CoinPlot.js
badd +34 js/mainGame/MarioGame.js
badd +0 js/GameUI.js
badd +0 js/TestPlot.js
badd +16 js/View.js
badd +53 js/MarioMaker.js
badd +0 index.html
badd +52 js/mainGame/Score.js
badd +0 js/mainGame/Mario.js
...
wincmd w
argglobal
if bufexists('~/projects/mario/js/marioAgent/model.js') | buffer ~/projects/mario/js/marioAgent/model.js | else | edit ~/projects/mario/js/marioAgent/model.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 30 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 180 + 105) / 211)
tabedit ~/projects/mario/js/mainGame/MarioGame.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 911 - ((33 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
911
...
wincmd w
argglobal
if bufexists('~/projects/mario/js/GameUI.js') | buffer ~/projects/mario/js/GameUI.js | else | edit ~/projects/mario/js/GameUI.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((12 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
...
exe 'vert 1resize ' . ((&columns * 105 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
tabedit ~/projects/mario/js/MarioMaker.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 155 - ((48 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
155
...
wincmd w
argglobal
if bufexists('~/projects/mario/js/View.js') | buffer ~/projects/mario/js/View.js | else | edit ~/projects/mario/js/View.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 105 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
tabedit ~/projects/mario/js/mainGame/Mario.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
if bufexists('~/projects/mario/js/mainGame/Score.js') | buffer ~/projects/mario/js/mainGame/Score.js | else | edit ~/projects/mario/js/mainGame/Score.js | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 105 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 105 + 105) / 211)
tabedit ~/projects/mario/js/CoinPlot.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 08|
lcd ~/projects/mario
tabedit ~/projects/mario/css/style.css
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 386 - ((30 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
386
...
wincmd w
argglobal
if bufexists('~/projects/mario/index.html') | buffer ~/projects/mario/index.html | else | edit ~/projects/mario/index.html | endif
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
